...
def help():
    ...
    helpMessage = "╔═════════════════\n" +\
                  ...
                  "╠➩" + key + "Listprotect\n" + \
                  "╠══════════════════════\n" +\
                  "║●●●●" + key + "SQUAD ANJING BIRU ●●●●\n" +\
                  "║" + key + " ●● https://line.me/ti/p/Y2kToe-r0S ●● \n" +\
                  "╚══════════════════════"
    return helpMessage
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"ANJING BIRU Creator") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage1(msg)
                               cl.sendMessage(msg.to,"「 SQUAD ANJING BIRU」")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "「 SQUAD ANJING BIRU 」Grup Info\n\nNama Group : {}".format(G.name)+ "\n❧ID Group : {}".format(G.id)+ "\n❧Pembuat : {}".format(G.creator.displayName)+ "\n❧Waktu Dibuat : {}".format(str(timeCreated))+ "\n❧Jumlah Member : {}".format(str(len(G.members)))+ "\n❧Jumlah Pending : {}".format(gPending)+ "\n❧Group Qr : {}".format(gQr)+ "\n❧Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "「 SQUAD ANJING BIRU」 Grup Info\n"
                                ret_ += "\nNama Group : {}".format(G.name)
                                ret_ += "\nID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「ADMIN ANJING BIRU 」\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」「SQUAD ANJING BIRU 」 " %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                G.preventedJoinByTicket = True
                                kc.updateGroup(G)
                                ki.sendMessage(msg.to,"「 ANJING BIRU 1 DONE」")
                                kk.sendMessage(msg.to,"「ANJING BIRU 2 DONE」")
                                kc.sendMessage(msg.to," 「 ANJING BIRU 3 DONE」")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendText(msg.to, "「SQUAD ANJING BIRU 1 2 3 PAMIT DULU .. MAU CARI MAKAN!! BYE 」 "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "「 ANJING BIRU RESPON」\n\n  「 Get Profile」\n   %.10f\n 「Get Contact」\n   %.10f\n 「Get Group」\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin:
                               cl.sendMessage(to," 「ADMIN ANJING BIRU HADIR」")
                               ki.sendMessage(to," 「BOTS ANJING BIRU 1」")
                               kk.sendMessage(to," 「BOTS  ANJING BIRU 2」")
                               kc.sendMessage(to,"「 BOTS  ANJING BIRU 3 」")
                               sw.sendMessage(to," 「MY GHOST STAY .. SAVE YOUR GROUP」 ")
                               
                        elif cmd == "my team" or msg.text.lower == "my team":
                      	  if msg._from in admin:
                       	    cl.sendMessage(to,"╔═════════════ \n ╠➢ Open Order Bot .. /n ╠➢ 1 admin + 2 asist /n ╠➢ 1 admin + 4 asist + 1 ghost /n ╠═══════════ /n ║ ●● jika minat silahkan contact kami ●● /n ╠➢ https://line.me/ti/p/Y2kToe-r0S /n ╚══════════════")
